...
""")
    ...
    Page<Case> findByCaseStatus(CaseStatus status, Pageable pageable);
    ...
    boolean existsByInvestigatedCustomerCustomerAndInvestigatedCustomerIsOpenTrue(@Param("customerNumber") String customerNumber);
